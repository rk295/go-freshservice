...
//go:generate gen --endpoint asset --generate-list asset.gen.go
...
//go:generate gen --endpoint department --generate-list department.gen.go
//go:generate gen --endpoint location --generate-list location.gen.go
...
//go:generate gen --endpoint ticket --generate-list ticket.gen.go
